  ...
  return (
    <div className="section-inner">
      <div className="mb-14 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        ...
        <Link
          href="/blog"
          className="inline-flex items-center gap-2 text-base font-semibold text-[var(--gold)] transition-transform hover:translate-x-1"
        >
          Tüm Yazıları Gör
          <ArrowRight size={16} />
        </Link>
          ...
          >
            ...
            >
              <span className="rounded-full border border-[var(--gold-dim)] bg-black/20 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.28em] text-[var(--gold)]">
                Yazı {String(index + 1).padStart(2, "0")}
              </span>
            </div>
